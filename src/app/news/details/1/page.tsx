...
import { dateText, titleText, referenceText, renderDescriptionText } from "../helper";
    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="px-4">
        ...
        <div className="mt-4 pb-20">
          ...
          {renderDescriptionText("“Kalau kondisi ini didiamkan, maka cepat atau lambat dia akan jatuh ke diabetes,” katanya dalam temu media Hari Diabetes Nasional 2021. ")}
          {renderDescriptionText("Pihaknya menekankan bahwa upaya pencegahan primer harus dilakukan secepatnya sejak prediabetes bahkan diabetes agar tidak menimbulkan masalah kesehatan lainnya seperti komplikasi jantung. Menurutnya, cara ini jauh lebih efisien dan efektif untuk menangani pasien daripada saat mereka sudah jatuh sakit. ")}
          {renderDescriptionText("Salah satu upaya pencegahan primer adalah dengan mencapai berat badan ideal. Dalam salah satu studi menyebutkan dengan penurunan BB sekitar 6,5% setelah 4 minggu diet rendah kalori hasilnya tekanan darah, gula darah dan kolesterol turun. ")}
          {renderDescriptionText("“Diabetes masalah besar di Indonesia. Yang paling penting adalah mengelola pola hidup, jangan lupa rutin melakukan aktivitas fisik, jaga pola makan dan melakukan pemeriksaan dini,” tuturnya. ")}
          {renderDescriptionText("Ancaman diabetes tidak hanya dihadapi oleh kelompok usia dewasa, tapi penyakit ini juga dapat mengancam anak-anak. ")}
          {renderDescriptionText("Mewakili Ikatan Dokter Anak Indonesia (IDAI) Dr. Muhammad Faizi, Sp.A(K) menyebutkan prevalensi Diabetes Melitus pada anak di Indonesia jumlahnya terus meningkat, didominasi remaja berusia 10-12 tahun serta anak berusia 5-6 tahun. ")}
          {renderDescriptionText("“Populasi anak-anak diabetes itu banyak di Indonesia Bagian Barat, yang Timur sedikit,” katanya. ")}
          {renderDescriptionText("Agar kadar gula darah terkontrol, dr. Faizi menjabarkan manajemen pada anak dengan diabetes merujuk pada 5 pilar diantaranya suntikan insulin, monitoring kadar gula darah, pemberian nutrisi, aktivitas fisik serta edukasi seumur hidup. Namun demikian, yang menjadi tangan besar yang dihadapi dalam pengendalian Diabetes di Indonesia adalah pasien sering kali terlambat mengetahui penyakit DM. Sehingga, sering ditemukan pada tahap lanjut atau sudah disertai dengan komplikasi, seperti serangan jantung dan stroke, infeksi kaki yang berat yang dapat mengakibatkan kecacatan sampai kematian dini. “Masalah kita adalah awareness kita tentang Diabetes Militus tipe 1, sehingga banyak pasien-pasien yang datang terlambat,” ucapnya. Agar kadar gula darah terkontrol, dr. Faizi menjabarkan manajemen Diabetes Militus dengan merujuk pada 5 pilar diantaranya suntikan insulin, monitoring kadar gula darah 6 kali sehari, asupan nutrisi, aktivitas fisik serta edukasi seumur hidup. ")}
          {renderDescriptionText("Kepala Biro Komunikasi dan Pelayanan Masyarakat(drg. Widyawati, MKM)")}
        </div>
      </div>
